...
public class history extends javax.swing.JFrame {
    ...
    public void history(){
       try{
            ...
            ResultSet rs1 = st.executeQuery("select *from history where h_id='"+questionId+"'");
            while(rs1.next()){
...
//            Connection con = ConnectionProvider.getCon();
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost/quiztime","root","");
            Statement st = con.createStatement();
            st.executeUpdate("Update users set Hmarks='"+marks+"' where rollNo='"+rollNo+"' ");
            String marks1 = String.valueOf(marks);
