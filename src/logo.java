...
public class logo extends javax.swing.JFrame {
    ...
    public void logo(){
       try{
            ...
            ResultSet rs1 = st.executeQuery("select *from logo where l_id='"+questionId+"'");
            while(rs1.next()){
...
//            Connection con = ConnectionProvider.getCon();
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost/quiztime","root","");
            Statement st = con.createStatement();
            st.executeUpdate("Update users set Lmarks='"+marks+"' where rollNo='"+rollNo+"' ");
            String marks1 = String.valueOf(marks);
